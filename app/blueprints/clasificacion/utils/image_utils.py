"""
Utilidades para manejo de imágenes en el módulo de clasificación.
"""
import os
import logging
...
def normalize_image_path(image_path, url_guia, static_folder=None):
    ...
    # Si la ruta ya está en formato correcto (sin static/)
    if isinstance(image_path, str) and image_path.startswith(("fotos_racimos_temp/", "uploads/fotos/", "uploads/clasificacion/", "clasificaciones/fotos/")):
        logger.info(f"La ruta ya está en formato relativo correcto: {image_path}")
